...
@Deprecated
public class KafkaLowLevelWorker implements Runnable {
    ...
    public KafkaLowLevelWorker(KafkaLowLevelConsumer kafkaConsumer, ElasticsearchProducer elasticsearchProducer, ESLogger logger) {
